...
SUPPORTED_COMBINATIONS = [
    ...
    {"use_postgis": "y"},
    {"use_postgis": "n"},
    {"postgresql_postgis_version": "11.3/11-3.0"},
    {"postgresql_postgis_version": "10.8/10-3.0"},
    {"postgresql_postgis_version": "9.6/9.6-3.0"},
    {"postgresql_postgis_version": "9.5/9.5-3.0"},
    {"postgresql_postgis_version": "9.4/9.5-3.0"},
